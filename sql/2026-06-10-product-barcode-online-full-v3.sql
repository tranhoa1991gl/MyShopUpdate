/*
    MyShop Online SQL Migration V3 - Barcode
    Mục đích: vá mã vạch sản phẩm cho cơ chế OnlineSqlUpdater.
    Bản V3 không dùng GO; mọi câu tham chiếu barcode sau ALTER TABLE được chạy bằng EXEC dynamic để tránh lỗi compile.
*/
...
/* =========================================================
   ...
   Lưu ý: dùng EXEC dynamic vì OnlineSqlUpdater chạy 1 batch, tránh lỗi compile
   "Invalid column name 'barcode'" khi cột vừa được ALTER TABLE.
   ========================================================= */
